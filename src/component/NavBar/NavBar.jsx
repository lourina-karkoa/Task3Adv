    ...
    <div className={stylenav  ? 'LK-NAV-Secound-Scroll': 'LK-NAV-Secound'}>
      ...
      <div className='lk-nav-s-o'>
        <ul className='lk-nav-ul'> 
          <li><Link to={'/'} className='lk-nav-li-link'>Home</Link> </li>
          <li><Link to={'/properties'} className='lk-nav-li-link'>Properties</Link></li>
          <li><Link to={'/property'} className='lk-nav-li-link'>Property Detalis</Link></li>
          <li><Link to={'/contact'} className='lk-nav-li-link'>Contact US</Link></li>
        </ul>
